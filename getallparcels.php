...
# the resulting point.
$sql =  "
    SELECT * FROM public.parcelsfinal WHERE
    ST_Contains(
        parcelsfinal.geom, 
        ST_Transform(
            ST_SetSRID(
...
?>	<b><p style="font-size:15px">Parcel Report</b></p><br>
...
HCP measures apply to both direct and indirect project impacts. As such, measures for adjacent parcels within specified buffer distances may be included.</p></b></font><br>	
...
<tr style="height: 20px;">
<td style="class: border-bottom; width: 250px; height: 20px;background-color: #F7F6F0; font-size: 10; border-color: #767676; border-width: 0.5px;border-style: solid; border-left: none; border-right: none;">VFG MIT 1-1, 1-2, amd 1-3: Habitat Mitigation in all Vernal Conservation Pool Measures must be reviewed</td>
</tr><?php }?>
